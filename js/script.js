var JsonNotas = '{"notas":[{' +
'"codigo": "00001", "nombre": "Jorge Villarreal", 	"nota": 5 },{ ' +
'"codigo": "00002", "nombre": "Maria Hernandez", 	"nota": 3.3 },{ ' +
'"codigo": "00003", "nombre": "Gustavo De La Vega Garcia", 	"nota": 4.6 },{ ' +
'"codigo": "00004", "nombre": "Marisela Hernandez",  	"nota": 4.1 },{ ' +
'"codigo": "00007", "nombre": "Jessica Lozada",	"nota": 4.0	},{ ' +
'"codigo": "00005", "nombre": "Sofia Yunda", 	"nota": 2.9 },{ ' +
'"codigo": "00006", "nombre": "Carmen Luna", 	"nota": 3.0 },{ ' +
'"codigo": "00008", "nombre": "Lesly Yarely",		"nota": 3.7 },{ ' +
'"codigo": "00009", "nombre": "Bragnin Perdomo", 	"nota": 3.5 },{ ' +
'"codigo": "00010", "nombre": "Nathalia Paris", 	"nota": 4.5 }]}';
...
function validar(){
  ...
  relleno();
   ...
   for (var wi = 0; wi <= json.notas.length - 1; wi++){
	...
	if(int_nota >= 1 && int_nota <= 5 && int_nota != ""){
		not_val = true;
	}else {
